                ...
                <div className="flex flex-col justify-center items-center gap-[3rem]">
                    <>
                        ...
                        <div className='flex flex-col gap-2 w-fit mx-auto'>
                            <Button  icon={< FcGoogle className='text-3xl '/>} text={`${createUser ? 'Sign Up With Google' : "Sign In With Google"}`}/>
                            <Button  icon={<MdFacebook className="text-3xl  text-blue-600" />} text={`${createUser ? 'Sign Up With FaceBook' : "Sign In With FaceBook"}`}/>
                            <Button icon={<AiOutlineMail className="text-3xl"/>} text={`${createUser ? 'Sign Up With E-Mail' : "Sign In With E-Mail"}`}/>
                        </div>
...
const Button = ({icon, text, click}) => {
    return(
        <button className='flex items-center h-[3rem] gap-10 sm:w-[20rem] border border-black
